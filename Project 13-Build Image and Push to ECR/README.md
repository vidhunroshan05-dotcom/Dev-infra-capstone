...
In this project, a simple Flask application was containerized using Docker.

The Docker image was built locally, tagged appropriately, and pushed to an Amazon ECR repository.

This demonstrates how container images are published to a cloud registry for later deployment in cloud environments.
